pipeline {
    ...
    stages {
       stage ('GIT') {
               steps{
                 script{
                     checkout([$class: 'GitSCM', branches: [[name: '*/main']],userRemoteConfigs: [[ credentialsId: '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',url :'https://github.com/hanenemho/cd_app']]])                
                 }
